function config() {
    return {
            ...
            cellData: 'https://api.github.com/repos/acycliq/3d_viewer/contents/data/cellData',
            geneData: 'https://api.github.com/repos/acycliq/3d_viewer/contents/data/geneData',
            cellBoundaries: 'https://api.github.com/repos/acycliq/3d_viewer/contents/data/cellBoundaries',
