...
void main() 
{
        ...
        float line_1 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5, 0.5 + 0.658351875 * 0.5), vec2(0.5 + 0.618027443 * 0.5, 0.5 + 1.0 * 0.5));
        float line_2 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5 + 0.618027443 * 0.5, 0.5 + 1.0 * 0.5), vec2(0.5 + 0.5 * 0.5, 0.5 + 0.27637816 * 0.5));
        float line_3 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5 + 0.5 * 0.5, 0.5 + 0.27637816 * 0.5), vec2(0.5 + 1.0 * 0.5, 0.5 - 0.236080209 * 0.5));
        float line_4 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5 + 1.0 * 0.5, 0.5 - 0.236080209 * 0.5), vec2(0.5 + 0.309026865 * 0.5, 0.5 - 0.341634306 * 0.5));
        float line_5 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5 + 0.309026865 * 0.5, 0.5 - 0.341634306 * 0.5), vec2(0.5 + 0.0 * 0.5, 0.5 - 1.0 * 0.5));
        float line_6 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5 + 0.0 * 0.5, 0.5 - 1.0 * 0.5), vec2(0.5 - 0.309026865 * 0.5, 0.5 - 0.341634306 * 0.5));
        float line_7 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5 - 0.309026865 * 0.5, 0.5 - 0.341634306 * 0.5), vec2(0.5 - 1.0 * 0.5, 0.5 - 0.236080209 * 0.5));
        float line_8 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5 - 1.0 * 0.5, 0.5 - 0.236080209 * 0.5), vec2(0.5 - 0.5 * 0.5, 0.5 + 0.27637816 * 0.5));
        float line_9 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5 - 0.5 * 0.5, 0.5 + 0.27637816 * 0.5), vec2(0.5 - 0.618027443 * 0.5, 0.5 + 1.0 * 0.5));
        float line_10 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5 - 0.618027443 * 0.5, 0.5 + 1.0 * 0.5), vec2(0.5, 0.5 + 0.658351875 * 0.5));
        float line_11 = 1.0 - lineSegment(gl_PointCoord, vec2(0.5, 0.5 + 0.658351875 * 0.5), vec2(0.5, 0.5 + 0.658351875 * 0.5));
