function get_cell_xyz() {
    var data = [],
        sphere_position = [
            {x: 35, y: 15 + 16.0, z: 17.5},
            {x: -44, y: 23 + 16.0, z: -2.5},
            {x: 43, y: 100 + 16.0, z: -3.5},
            {x: 43, y: 88 + 16.0, z: -15.5},
            {x: 43, y: 126.5 + 16.0, z: 15},
            {x: -5, y: 115.5 + 16.0, z: 7},
            {x: -73, y: -121.5 + 16.0, z: 5.5},
            {x: -66, y: -150.5 + 16.0, z: 17.5},
            {x: -53, y: -27 + 16.0, z: -7.5},
            {x: 10, y: -95 + 16.0, z: -3},
            {x: -20, y: -90 + 16.0, z: -12},
            {x: -13, y: -175 + 16.0, z: -3},
            {x: -125, y: -15 + 16.0, z: 20},
        ],
        sphere_scale = [
            {x: 7.5, y: 10, z: 3.0},
            {x: 15, y: 25, z: 10},
    ...
    for (var i = 0; i < sphere_position.length; i++) {
        var dp = sphere_position[i],
            ...
            dc = sphere_color[i];
        data.push({
            position: new THREE.Vector3(dp.x, dp.y, dp.z),
